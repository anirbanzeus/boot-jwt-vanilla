...
public class ExceptionHandling implements ErrorController {
    ...
    private ResponseEntity<HttpResponse> createHttpResponse(HttpStatus status, String message){
        return new ResponseEntity<>(new HttpResponse(status.value(), status,
                status.getReasonPhrase().toUpperCase(Locale.ROOT), message.toUpperCase(Locale.ROOT)), status);
    }
    ...
    @ExceptionHandler(com.policyportal.exception.domain.EmailExistsException.class)
    public ResponseEntity<HttpResponse> emailExistException(com.policyportal.exception.domain.EmailExistsException exception) {
